...
internal class TokenCollectorListener : SPARQLParserBaseListener
{
  ...
  {
    if (node.Symbol.Type == this.tokenType &&
        (string.IsNullOrEmpty(this.text) || string.Equals(node.Symbol.Text, this.text, this.stringComparison)))
    {
