...
public partial class SPARQLParser : Parser {
	...
	public const int
		SPACE=1, COMMENT=2, TRUE=3, FALSE=4, DISTINCT=5, NOT=6, IN=7, STR=8, LANG=9, 
		LANGMATCHES=10, DATATYPE=11, BOUND=12, IRI=13, URI=14, BNODE=15, RAND=16, 
		ABS=17, CEIL=18, FLOOR=19, ROUND=20, CONCAT=21, STRLEN=22, UCASE=23, LCASE=24, 
		ENCODE_FOR_URI=25, CONTAINS=26, STRSTARTS=27, STRENDS=28, STRBEFORE=29, 
	...
	private static readonly string[] _SymbolicNames = {
		null, "SPACE", "COMMENT", "TRUE", "FALSE", "DISTINCT", "NOT", "IN", "STR", 
